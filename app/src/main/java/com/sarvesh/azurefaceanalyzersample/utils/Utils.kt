package com.sarvesh.azurefaceanalyzersample.utils
...
import com.sarvesh.azurefaceanalyzersample.constants.FACE_API_KEY
...
object Utils {
    ...
    fun getFaceAPISessionToken(context: Context, verifyImage: ByteArray? ) {
        ...
        getFaceAPISessionToken(FACE_API_ENDPOINT, FACE_API_KEY, verifyImage, sendResultsToClient, context.contentResolver)
    }
